...
include 'connection.php';
 ...
 $query = "SELECT * FROM appraisal_replies INNER JOIN appraisal ON appraisal.id = appraisal_replies.appraisal_id WHERE appraisal.companyId = '".$_SESSION['user']['companyId']."'";
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="pointer">
                            ...
                            <?php }else {?>
                              <td class="text-center"><a href="/newhrcore/get_this_staff_appraisal.php/?appraisal_id=<?=base64_encode($to_show_appraisal[$h]['appraisal_id'])?>&staff_id=<?=base64_encode($to_show_appraisal[$h]['staff_id'])?>" class="btn btn-sm btn-success">View</a></td>
                            <?php } ?>  
                           <?php }?>
                        </tbody>
                      </table>
