...
$query = "SELECT courses.link,courses.id, assigncourse.date_created, courses.title,assigncourse.department,assigncourse.userId, assigncourse.id as assign_id, courses.filename FROM assigncourse INNER JOIN courses ON courses.id = assigncourse.courseId INNER JOIN coursecategory ON coursecategory.id = courses.id  WHERE assigncourse.companyId = '".$_SESSION['user']['companyId']."' AND (assigncourse.department = '".$_SESSION['user']['department']."' OR assigncourse.userId = '".$_SESSION['user']['id']."') ORDER BY courses.id DESC";
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="pointer">
                            ...
                            <th class="column-title"><a href="process_course.php/?courseid=<?=base64_encode($courses[$h]['id'])?>&view=staff" class="btn btn-sm btn-success">Details</a> </th>
                          </tr>
                           <?php }?>
                        </tbody>
                      </table>
