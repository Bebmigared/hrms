                          ...
                          <div class="x_content">
                            ...
                            <form action="process_employee_basic_info.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" name="status" class="form-control col-md-7 col-xs-12" required="required" type="text" value ="<?=isset($_SESSION['employee']) ? $_SESSION['employee'][0]['status']:''?>">
                                </div>
                              </div>
                              <div class="form-group">
                        ...
                        <br />       
                         <form action="process_employee_payroll_data.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="hmo" name="hmo" class="form-control col-md-7 col-xs-12" required="required" type="number" value ="<?=isset($_SESSION['employee_payroll_data']) ? $_SESSION['employee_payroll_data'][0]['HMO']:''?>">
                                </div>
                              </div>
                              <div class="form-group">
