            ...
            <div class="row">
              ...
              <div class="col-md-8 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form enctype="multipart/form-data" action="process_share_knowledge.php" method="POST">
                        <div class="form-group">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Subject</label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea class="resizable_textarea form-control" name="subject" placeholder="Enter a Subject here..."></textarea>
