   ...
   $date_obtained = mysqli_real_escape_string($conn, $_POST['date_obtained']);
    if($qualification == ''){
      $msg = 'kindly input the qualification you acquired';
       ...
       $sql = "INSERT INTO qualifications (qualification_name, grade, institution, course_of_study, date_obtained, specialization,staff_id, admin_id, companyId)
          VALUES ('".$qualification."', '".$grade."', '".$institution."','".$course_of_study."','".$date_obtained."','".$specialization."','".$_SESSION['user']['id']."','".$_SESSION['user']['admin_id']."', '".$_SESSION['user']['companyId']."')";
