...
if($_SESSION['user']['category'] == 'staff'){
  ...
  $query = "SELECT * FROM open_information_portal WHERE admin_id = '".$_SESSION['user']['admin_id']."'";
...
//get user data
$query = "SELECT * FROM certifications WHERE companyId = '".$_SESSION['user']['companyId']."' AND staff_id = '".$_id."'";
$result = mysqli_query($conn, $query);
