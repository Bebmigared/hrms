      ...
      <div class="">
        ...
        <div class="right_col" role="main" style="width:100%;margin-left:5px;">
            <div class="">
                ...
                <div class="row" style="">
                  <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                    <h4>Grant Permission to a department and access will be granted everyone in that department.</h4>
                    <h4>Select a Staff will grant access to selected staff Only</h4>
                  </div>
                  <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                    <div class="x_panel">
                      <div class="x_title">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                               ...
                               <?php if(count($data) > 0) {?>
                                    <?php for ($r = 0; $r < count($users); $r++){ ?>
                                      ...
                                      <option value = "<?=$users[$r]['email']?>"><?=$users[$r]['name']?> <?=$users[$r]['fname']?></option>
                                <?php } } ?> 
                                </select>
                            </div>
                          </div>
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                            <button type="submit" name="manage_permission" class="btn btn-success">Submit</button>
                          </div>
                        </form>
                      </div>
                    </div>
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form action="process_permission.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                            <button type="submit" name="manage_talent" class="btn btn-success">Submit</button>
                          </div>
                        </form>
                      </div>
                    </div>
                      ...
                      <div class="x_content">
                        ...
                        <form action="process_permission.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                            <button type="submit" name="manage_employee" class="btn btn-success">Submit</button>
                          </div>
                        </form>
                      </div>
                      </div>
                      <div class="x_panel">
                      <div class="x_title">
                        <h2>Manage Requisition Processing</h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        <br />
                        ...
                        <form action="process_permission.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                            <button type="submit" name="manage_request" class="btn btn-success">Submit</button>
                          </div>
                        </form>
                      </div>
                      </div>
                      ...
                      <div class="x_content">
                        ...
                        <form action="process_permission.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"> 
                            <button type="submit" name="create_voucher" class="btn btn-success">Submit</button>
                          </div>
                        </form>
                      </div>
                      </div>
