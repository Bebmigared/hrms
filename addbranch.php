                    ...
                    <div class="x_content">
                      ...
                      <form action="process_addbranch.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" name="phone_number" class="form-control col-md-7 col-xs-12" required="required" type="text" value = "">
                                </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" name="email" class="form-control col-md-7 col-xs-12" required="required" type="email" value = "">
                                </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="text" name="address" class="form-control col-md-7 col-xs-12" required="required" type="text"></textarea>
                                </div>
                        </div>
                        <div class="form-group" style="display: none;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="text" name="branch_id" class="form-control col-md-7 col-xs-12"  type="text"></textarea>
                                </div>
                        </div>
