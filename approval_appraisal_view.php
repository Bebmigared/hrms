                  ...
                  <div class="x_content">
                        ...
                        <div style="text-align: center;">
                            ...
                            <div style="text-align: left;">
                              <?php if ($appraisal[0]['appraisal_replies_flow'] != "") {?>
                              <?php $appraisal_flow = explode(";",$appraisal[0]['appraisal_replies_flow']) ?>
                             ...
                             <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2 each_questions">
                               ...
                               <div style="text-align: justify;">
                                  ...
                                  <?php $appraisal_data = explode("%%%",$appraisal[$t]['appraisal_data'])?>
                                   ...
                                   <div id="questionrow">
                                      <h5 style = 'margin-top:10px;font-weight: 700'>Question 1</h5><p><?=$thisappraisal[0]->question?></p>
                                      <h5 style = 'margin-top:10px;font-weight: 700'>Weight <span style="font-weight: 500"> <?=$thisappraisal[0]->weight?>%</span></h5>
                                      <h5 style = 'margin-top:10px;font-weight: 700'>Score <span style="font-weight: 500"> <?=$thisappraisal[0]->remark?></span></h5>
                                      <h5 style = 'margin-top:10px;;font-weight: 500'>Justification</h5>
                                      <p><?=$thisappraisal[0]->justification?></p>    
                                   </div>

                                  <?php $flow = explode(";",$appraisal[$t]['appraisal_replies_flow']) ?> 
                               ...
                               <div class="row">
                                 <div class="btn-group main_btn" role="group" aria-label="Basic example" style="margin-top: 10px;">
                                  <button type="button" class="btn btn-warning" question = "0" who = "<?=$eachflow[0]?>" appraisal_data = '<?=$appraisal[0]['responses']?>' style="margin: 4px;" id="mprevious" appraisal_flow = '<?=$appraisal[$t]['appraisal_replies_flow']?>'>Previous</button>
                                  <button type="button" class="btn btn-primary" question = "0"  who = "<?=$eachflow[0]?>" appraisal_data = '<?=$appraisal[0]['responses']?>' style="margin: 4px;" id="mnext" appraisal_flow = '<?=$appraisal[$t]['appraisal_replies_flow']?>'>Next</button>
                                 </div> 
                              </div>
                    ...
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                         ...
                         <?php $flow = explode(";",$appraisal[0]['appraisal_replies_flow']) ?> 
                          <?php for($e = 0; $e < count($flow); $e++) { ?>
                          <?php $eachflow = explode(":",$flow[$e]) ?>   
                         <tr>
                          <th scope="row"><?=$e+2?></th>
                              ...
                              //echo $score.'<br>';
                                ...
                                if(isset($thisappraisal[$r]->manager_remark))
                                {
                                  for($p = 0; $p < count($thisappraisal[$r]->manager_remark); $p++) { 
                                    if($thisappraisal[$r]->manager_remark[$p]->who == $eachflow[0])
...
<script type="text/javascript" src="js/appraisal.js?version=1.31"></script>
