        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      <br />
                      <form action="process_exit.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="width: 100%">
         <form  method = "POST" enctype="multipart/form-data">
           <?php
              if($_SESSION['user']['exit_flow'] != '')
              {?>
               <h3>Your Current flow</h3> 
            <?php 
                
                $flow = explode(';',$_SESSION['user']['exit_flow']);
                $value = 'Staff';
              ...
              <hr />
              <?php
              }else if($_SESSION['user']['exit_flow'] == '' && isset($_SESSION['approval_settings']) && $_SESSION['approval_settings'] == '1'){?>
