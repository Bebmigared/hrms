...
try {
    ...
    $mail->Username   = 'bcodestechnology@outlook.com';                     //SMTP username
    $mail->Password   = 'lighgC0dex#w';                                 // SMTP password
    $mail->SMTPSecure = 'tls';  
    ...
    //Recipients
    $mail->setFrom('bcodestechnology@outlook.com', 'HRCORE');
    $mail->addAddress($to, 'ICS');     // Add a recipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    $mail->addReplyTo('info@hrcore.ng', 'HRCORE');
