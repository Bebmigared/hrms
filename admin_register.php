   ...
   <section id="pricing" class="wow fadeInUp section-bg">
      ...
      <div class="container">
        ...
        <div class='ourform' style="">
          ...
          <?php } ?> 
          <form action = "admin_register_user.php" method="POST" role="form" class="oldcontactForm">
                          <div class="form-group">
                              <input type="text" id="first-name" name = "email" required="required" class="form-control" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email">
                          </div>
                          <div class="form-group">
                              <input type="text" id="first-name" name = "company_name" Placeholder="Company Name" required="required" class="form-control">
                          </div>
                          <div class="form-group">
                              <input type="password" id="last-name" name="password" placeholder="Password" required="required" class="form-control">
                          </div>
                          <div class="form-group">
                              <input type="password" id="last-name" name="confirm_password" placeholder='Confirm Password' required="required" class="form-control">
                          </div>
