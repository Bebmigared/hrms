...
if(isset($_POST['submit'])){
  ...
  $query = "SELECT * from branches WHERE name = '$name' AND company_id = '".$_SESSION['user']['companyId']."'";
  ...
  $sql = "INSERT INTO branches (name, phone_number, email, address, date_created, company_id, insert_by)
  VALUES ('".$name."', '".$phone_number."', '".$email."','".$address."','".date('Y-m-d')."', '".$_SESSION['user']['companyId']."','".$_SESSION['user']['id']."')";
