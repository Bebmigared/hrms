  ...
  if(isset($_POST['submit'])){
      ...
      if($password == ''){
          ...
          if (mysqli_query($conn, $sql)) {
              $_SESSION['msg'] = "Password Reset.... Proceed to Login";
          }else {
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <?php } ?>
                        <form action = "resetpassword.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="password" id="password" name="cpassword" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                          </div>
                          
                          <div class="ln_solid"></div>
                          <div class='col-md-12 col-sm-12 col-lg-12 col-xs-12' style='text-align:right;margin-top:-10px'>
                               <a href = 'login'>Go to Login</a></a>
                          </div>
