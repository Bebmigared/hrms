...
$query = "SELECT users.name, users.employee_ID,id_card.signature,id_card.status,id_card.date_created,id_card.staff_id,id_card.IID as request_id,users.branch,users.department, users.role, users.phone_number,id_card.justification, id_card.comment FROM id_card INNER JOIN users ON users.id = id_card.staff_id WHERE id_card.staff_id = '".$_SESSION['staff_id']."'";
          ...
          <div class="">
            ...
            <div class="row">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <tr class="pointer">
                            ...
                            <td class="text-center" style="text-align: justify;word-wrap: break-word;"><?=$id_request[$h]['justification']?></td>
              ...
              <div class="col-md-4 col-sm-12 col-xs-12">
                  <div class="x_panel">
                  <div class="x_title">
                    <h2>KSS shared by (<span style="font-size: 13px;"><?=$kss[0]['name']?></span>)</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <?php if(count($kss) > 0) {?>
