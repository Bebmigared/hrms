   ...
   $date_cert = mysqli_real_escape_string($conn, $_POST['date_cert']);
    if($certification == '' || $date_cert == ''){
      $msg = 'kindly input the required information';
       ...
       $sql = "INSERT INTO certifications (certification_name, date_cert,staff_id, admin_id, companyId)
          VALUES ('".$certification."', '".$date_cert."','".$_SESSION['user']['id']."','".$_SESSION['user']['admin_id']."', '".$_SESSION['user']['companyId']."')";
