                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <form action = "login_user.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class='col-md-12 col-sm-12 col-lg-12 col-xs-12' style='text-align:center;margin-top:-10px'>
                               <a href = 'forgotpassword'>Forgot Password?</a>
                          </div>
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="submit" class="btn btn-success">Login</button>
                            <p>Request a Demo <a class="btn btn-primary" href="contactus">Click Here</a></p>
