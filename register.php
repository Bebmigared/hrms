                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <?php } ?>
                        <form action = "register_user.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <p>Do you have an account? <a href ="login" class="btn btn-primary">Log In</a></p>
