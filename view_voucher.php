...
//print_r($_SESSION['user']);
 $query = "SELECT * FROM voucher ORDER BY created_at ASC";
                ...
                <thead>
                      ...
                      <?php for ($data = 0; $data < count($voucher); $data++) {?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if(($voucher[$data]['status']=='Awaiting Endorsement') || ($voucher[$data]['status']=='')) {?>
<!--                            <button type="button" class="btn btn-warning btn-xs"><?= (empty($voucher[$data]['status'])) ? 'Awaiting Endorsement' : $voucher[$data]['status']?></button>-->
                      ...
                      <div class="row no-print">
                        ...
                        <input type ="hidden" name="voucher_no" value="<?=$voucher[$data]['voucher_no']?>">
                          <?php if($_SESSION['user']['role']=='ed') {?>
                          <button type="submit" name="endorse" class="btn btn-danger pull-right"><i class="fa fa-credit-card"></i> Endorse</button>
                          ...
                          <?php } else {?>
                          <button type="button" class="btn btn-success btn-xs"><?=$voucher[$data]['status']?></button>
                          <?php }?>
                          </td>
                          <td>
                              <?php if($_SESSION['user']['role'] !='ed') {?>
                          ...
                          <input type="submit" name="edit" id="edit" value="Edit" class="btn btn-primary btn-xs" />
                      ...
                      <?php }?>
                         ...
                         <?php } elseif($_SESSION['user']['role']=='md' && $voucher[$data]['ed']=='1'){?>
                          <tr>
                          <td><?=$voucher[$data]['voucher_no']?></td>
                          <td><?=$voucher[$data]['client_name']?></td>
                          <td><?=$voucher[$data]['paying_bank']?></td>
                          ...
                          <td><?=$voucher[$data]['created_at']?></td>
                          <td>
                            <?php if($voucher[$data]['status']=='') {?>
                            <button type="button" class="btn btn-warning btn-xs"><?= (empty($voucher[$data]['status'])) ? 'Processing' : $voucher[$data]['status']?></button>
                          <?php } elseif($voucher[$data]['status']=='MD Approved'){?>
                            <button type="button" class="btn btn-success btn-xs"><?= (empty($voucher[$data]['status'])) ? 'Processing' : $voucher[$data]['status']?></button>
                         <?php } else {?>
                          <button type="button" class="btn btn-warning btn-xs"><?=$voucher[$data]['status']?></button>
                          <?php }?>
                          </td>
                          <td>
                          <form action="edit_voucher.php" method="POST">
                       ...
                       <a href="edit_voucher.php?voucher_no=<?php echo $voucher[$data]['voucher_no']; ?>  " target="_blank" class="btn btn-info btn-xs"> Edit</a>
                            <!--<a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>-->
                          </td>
                          <td>
