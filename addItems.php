                      ...
                      <ul class="nav navbar-right panel_toolbox">
                          <li>
                                <button type="submit" id="btnExport"
                                    name='export' value=""
                                    class="btn btn-primary" data-toggle="modal" data-target="#addModal">Upload Bulk Items</button>
                          </li>
                        </ul>
                      <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                      ...
                      <form action="process_additems.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group" hidden>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" name="item_category" class="form-control col-md-7 col-xs-12"  type="text">
                                </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" name="item_cost" class="form-control col-md-7 col-xs-12" required="required" type="number">
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <button type="submit" name="submit" class="btn btn-success">Add Item to Inventory</button>
                          </div>
                        </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div style="margin: 10px">
                ...
                <a class="btn btn-primary" href ="document/datainventory.xlsx">Download Sample</a>
              </div>
              <div class="modal-body">
                 <form action = 'process_inventory_list.php' method = "POST" enctype="multipart/form-data">
                  <div class="form-group">
